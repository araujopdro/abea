...
<html>
	...
	<body> 
		<div class="container py-4 z-index-1">
			...
			<div class="page py-4" id="preview-holder">
				...
				<div class="row flex-column p-2 m-2">
					...
					<div class="row px-4 pb-4 mx-4 mt-4">
						<div class="mx-auto h5">
							<!-- <span class="mx-2 h6" style="visibility: hidden;"><i class="far fa-eye"></i></span> -->
							<span>Bio</span>
							<!-- <span class="mx-2 h6"><i class="far fa-eye"></i></span> -->
						</div>
