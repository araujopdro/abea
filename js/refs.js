...
var habilidades = [
  {
    "nome": "Acrobacia",
    "categoria": "Habilidades Gerais",
    "niveis": [
      "rolamentos básicos e estrelinhas",
  ...
  },
  {
    ...
    "categoria": "Habilidades Gerais",
    "niveis": [
      "correr com uma velocidade acima da média",
      "correr distâncias maiores e em terrenos mais difíceis",
      "correr grandes distâncias em terrenos difíceis"
    ]
  },
  {
    "nome": "Equitação",
    "categoria": "Habilidades Gerais",
    "niveis": [
      "cavalgar animais treinados e aplicar cuidados básicos aos cavalos",
      "cavalgar em maior velocidade ou controlar animais mais temperamentais",
      "pular, correr e domar cavalos"
    ]
  },
  {
    "nome": "Força Física",
    "categoria": "Habilidades Gerais",
    "niveis": [
      "carregar armas pesadas",
      "levantar e carregar pesos acima do normal ou realizar feitos de força além do comum",
      "realizar atos de força nos limites do corpo humano é uma façanha difícil ou lendária"
    ]
  },
  {
    "nome": "Furtividade",
    "categoria": "Habilidades Gerais",
    "niveis": [
      "esconder-se em condições ideais",
      "esconder-se em situações adversas",
      "esconder-se e locomover-se de forma despercebida ao disfarçar seu som, aparência e cheiro"
    ]
  },
  {
    "nome": "Medicina de campo",
    "categoria": "Habilidades Gerais",
    "niveis": [
      "tratar feridas básicas e remover um ponto de dano",
      "remover dois pontos de dano",
      "remover três pontos de dano"
    ]
  },
  {
    "nome": "Natação",
    "categoria": "Habilidades Gerais",
    "niveis": [
      "nadar em águas calmas",
      "nadar em águas agitadas, fazer mergulho livre e socorrer outros em perigo",
      "nadar grandes distâncias, socorrer pessoas em circunstâncias extremas e segurar o fôlego durante vários minutos debaixo da água"
    ]
  },
  {
    ...
    "categoria": "Habilidades Gerais",
    "niveis": [
      "enganar os olhos de um espectador com ilusionismo",
      "enganar múltiplos espectadores",
      " furtar objetos dos bolsos ou fazer outros feitos notáveis com as mãos, sem ninguém perceber"
    ]
  },
  {
    "nome": "Armadilhas",
    "categoria": "Habilidades Silvestres",
    "niveis": [
      "capturar animais pequenos",
      "armadilhas mais complexas e escondê-las",
      "montar armadilhas capazes de prender grandes animais ou até mesmo seres humanos"
    ]
  },
  {
    "nome": "Canoagem",
    "categoria": "Habilidades Silvestres",
    "niveis": [
      "remar e navegar uma canoa",
      "navegar águas mais difíceis com correnteza",
      "navegar corredeiras"
    ]
  },
  {
    "nome": "Comida silvestre",
    "categoria": "Habilidades Silvestres",
    "niveis": [
      "alimentar uma pessoa",
      "alimentar um grupo",
      "alimentar uma pessoa em circunstâncias adversas (como neve ou deserto) ou para alimentar um grupo sob condições diversas"
    ]
  },
  {
    "nome": "Escalada",
    "categoria": "Habilidades Silvestres",
    "niveis": [
      "escalar uma superfície fácil de pedra, uma corda ou uma árvore",
      "escaladas maiores ou mais difíceis",
      "escaladas em situações mais difíceis (superfícies molhadas, retas), ou, com o equipamento certo, escalar montanhas"
    ]
  },
  {
    "nome": "Fauna silvestre",
    "categoria": "Habilidades Silvestres",
    "niveis": [
      " indicar hábitos básicos de animais comuns, como sua alimentação ou período de atividade",
      "reconhecer um animal pelas pegadas, ou identificar um pássaro incomum por seu canto",
      "representar um conhecimento profundo, como descobrir a última refeição e condição física de um animal pelo esterco, ou reconhecer a hierarquia entre um grupo de animais"
    ]
  },
  {
    "nome": "Folclore",
    "categoria": "Habilidades Silvestres",
    "niveis": [
      "o personagem adquire conhecimento de lendas e costumes"
    ]
  },
  {
    "nome": "Herbalismo",
    "categoria": "Habilidades Silvestres",
    "niveis": [
      "curar 1 ponto de dano em qualquer pessoa",
      "consegue tratar febres, doenças e venenos comuns",
      "doenças e venenos incomuns"
    ]
  },
  {
    "nome": "Navegação terrestre",
    "categoria": "Habilidades Silvestres",
    "niveis": [
      "reconhecer os pontos cardeais",
      "encontrar um caminho quando perdido na selva",
      "reencontrar um lugar previamente visitado"
    ]
  },
  {
    "nome": "Rastreamento",
    "categoria": "Habilidades Silvestres",
    "niveis": [
      "identificar vestígios mais óbvios de pessoas e animais",
      " rastrear algum animal ou pessoa sob condições ideais",
      "rastrear pessoas e animais sob condições mais difíceis"
    ]
  },
  {
    "nome": "Armas de arremesso",
    "categoria": "Armas",
    "descricao": [
      "estas armas são balanceadas para o arremesso, mas também podem ser utilizadas no corpo a corpo, se o personagem tiver a habilidade certa",
      "Lança, Faca de Arremesso, Machado de arremesso"
    ]
  },
  {
    "nome": "Armas de corte",
    "categoria": "Armas",
    "descricao": [
      "armas utilizadas para golpes cortantes ou para esfaquear o oponente",
      "Adaga, Alfanje, Espada de Lâmina Larga*, Faca, Machete"
    ]
  },
  {
    "nome": "Armas de fogo",
    "categoria": "Armas",
    "descricao": [
      "ao longo do século XVI, as armas de fogo começaram a se tornar as armas dominantes",
      "Arcabuz, Mosquete, Pistola"
    ]
  },
  {
    "nome": "Armas de golpe",
    "categoria": "Armas",
    "descricao": [
      "armas que dependem da força física do combatente para causar dano de impacto",
      "Machado de guerra, Martelo de guerra, Porrete"
    ]
  },
  {
    "nome": "Armas de haste",
    ...
    "descricao": [
      ...
      "Alabarda, Martelo de Lucerne, Pique"
    ]
  },
  {
    "nome": "Armas de sopro",
    "categoria": "Armas",
    "descricao": [
      "existem vários tipos e tamanhos de zarabatanas",
      "Zarabatana"
    ]
  },
  {
    "nome": "Armas mecânicas",
    "categoria": "Armas",
    "descricao": [
      "a besta, mesmo com sua popularidade diminuída, continuava sendo uma opção nas batalhas ao longo do século XVI",
      "Besta"
    ]
  },
  {
    ...
    "categoria": "Armas",
    "descricao": [
      "O arco é arma tradicional do mundo inteiro. Enquanto o século XVI viu seu uso diminuir na Europa, o arco e flecha continuou sendo a arma mais usada nas Américas, devido ao seu uso pelos povos nativos",
      "Arco e flecha"
    ]
  },
  {
    ...
    "categoria": "Armas",
    "descricao": [
      "estudo de luta com as espadas compridas de origem europeia",
      "Rapieira"
    ]
  },
  {
    ...
    "categoria": "Armas",
    "descricao": [
      "armas que dificilmente teriam chegado ao Brasil Colonial",
      "ex: Cimitara, Catana, Zweihänder"
    ]
  },
  {
    "nome": "Boxe",
    ...
    "niveis": [
      "dar golpes fortes com os punhos (dano 1)",
      "ganha um ponto a mais de resistência",
      "ganha outro ponto de resistência"
    ]
  },
  {
    "nome": "Capoeira",
    "categoria": "Artes Marciais",
    "descricao": [
      "pode usar esta habilidade para atacar com os pés (dano 1) ou para esquivas durante o combate"
    ]
  },
  {
    "nome": "Luta livre",
    "categoria": "Artes Marciais",
    "descricao": [
      "pode usar esta habilidade para tentar imobilizar oponentes de tamanho e força humanas"
    ]
  },
  {
    "nome": "Barganha",
    ...
    "niveis": [
      "negociar o custo de bens e serviços",
      "negociar o custo de bens e serviços com mais facilidade",
      "pode ser utilizada para convencer um vendedor mais “duro” ou conseguir um desconto maior"
    ]
  },
  {
    "nome": "Oratória",
    "categoria": "Habilidades Sociais",
    "descricao": [
      "desenvolvimento do poder da voz para persuadir um grupo"
    ]
  },
  {
    "nome": "Persuasão",
    "categoria": "Habilidades Sociais",
    "descricao": [
      "habilidade de persuadir outros, de levá-los para seu lado da discussão"
    ]
  },
  {
    "nome": "Artilharia",
    "categoria": "Habilidades Militares e Navais",
    "descricao": [
      "a artilharia só pode ser utilizada de pontos fixos, como fortalezas e navios. Artilharia não tem precisão para ser utilizada em pequenas batalhas. Estas peças servem para atacar grandes alvos, como navios e edifícios, ou para atirar no meio de exércitos."
    ]
  },
  {
    "nome": "Militar",
    "categoria": "Habilidades Militares e Navais",
    "niveis": [
      "uma habilidade básica para quem participa de guerras, como soldados e guerreiros nativos. Inclui aprendizagem de combate em grupo, cuidado de higiene e equipamento durante campanhas, nervos para enfrentar a batalha",
      "começa a aprender táticas militares, podendo organizar pequenos grupos em batalha",
      "aprende estratégia: como equipar grupos, preparar linhas de suprimento e escolher terrenos para travar batalhas"
    ]
  },
  {
    "nome": "Náutica",
    "categoria": "Habilidades Militares e Navais",
    "niveis": [
      " aprende a trabalhar com o vento, atar nós, limpar e cuidar de embarcações. Também consegue navegar barcos a vela pequenos",
      "navegar rotas conhecidas, lidar com mares perigosos e enfrentar situações táticas",
      "melhora as habilidades de navegação"
    ]
  },
  {
    "nome": "Alfaiataria",
    ...
    "descricao": [
      "alfaiates trabalham com a confecção de roupas. Pode-se demorar um dia para criar uma roupa simples, ou um mês para as mais difíceis (após obter todos os materiais necessários)"
    ]
  },
  {
    "nome": "Armaria",
  ...
  },
  {
    ...
    "categoria": "Artesanatos",
    "descricao": [
      "ferreiros trabalham com objetos de ferro. Um objeto simples pode ser criado em questão de horas, uma arma básica em uma semana e um objeto excepcional pode levar meses"
    ]
  },
  {
    "nome": "Marcenaria",
    "categoria": "Artesanatos",
    "descricao": [
      "marceneiros trabalham com criação de móveis e outros objetos de madeira. Peças básicas podem levar um dia para fazer, já peças decorativas, de madeiras especiais, podem levar meses"
    ]
  },
  {
    "nome": "Ourivesaria",
    "categoria": "Artesanatos",
    "descricao": [
      "o ourives faz trabalhos em prata e ouro. Trabalhos simples levam dias, e trabalhos grandes e complexos podem levar seis meses ou mais"
    ]
  },
  {
    "nome": "Sapataria",
    "categoria": "Artesanatos",
    "descricao": [
      "o sapateiro monta calçados de couro. Um par básico de calçados pode levar um dia para ser feito, um par mais elaborado pode levar semanas"
    ]
  },
  {
    "nome": "Tanoaria",
    "categoria": "Artesanatos",
    "descricao": [
      "tanoeiros confeccionam barris. A montagem de um barril leva um dia. Tanoeiros de níveis maiores são especialistas na seleção e formação da madeira, criando barris de melhor qualidade e maior durabilidade"
    ]
  },
  {
    "nome": "Culinária",
    "categoria": "Artes",
    "descricao": [
      "tendo os ingredientes certos, é capaz de criar pratos saborosos e até inéditos"
    ]
  },
  {
    "nome": "Dança",
  ...
  },
  {
    ...
    "categoria": "Artes",
    "descricao": [
      "desenhista trabalha com carvão, lápis, xilogravura ou outras formas de desenho"
    ]
  },
  {
    "nome": "Entalhe",
    "categoria": "Artes",
    "descricao": [
      "consegue entalhar desenhos ou esculturas de madeira"
    ]
  },
  {
    "nome": "Escultura",
    "categoria": "Artes",
    "descricao": [
      "apreende esculpir obras de argila ou mármore"
    ]
  },
  {
    "nome": "Pintura",
    "categoria": "Artes",
    "descricao": [
      "trabalha com pintura em aquarela ou tinta a óleo"
    ]
  },
  {
    "nome": "Poesia",
    "categoria": "Artes",
    "descricao": [
      "pode trabalhar com poesia, letras ou peças"
    ]
  },
  {
    "nome": "Teatro",
    "categoria": "Artes",
    "descricao": [
      "tem habilidade nas artes cênicas, ou como ator/atriz de peças ou em outras áreas, como marionetes"
    ]
  },
  {
    "nome": "Vocal",
    "categoria": "Artes",
    "descricao": [
      "faz treinamento da voz para cantar"
    ]
  },
  {
    "nome": "Instrumentos de corda",
  ...
  {
    "nome": "Instrumentos de corda e arco",
    "categoria": "Instrumentos Musicais",
    "descricao": [
  ...
  {
    "nome": "Instrumentos de embocadura",
    "categoria": "Instrumentos Musicais",
    "descricao": [
      "flauta, flauta doce, corneta, corneto, trombeta"
    ]
  },
  {
    "nome": "Instrumentos de palheta",
    "categoria": "Instrumentos Musicais",
    "descricao": [
      "baixão, charamela, fagote"
    ]
  },
  {
    "nome": "Instrumentos de percussão",
    "categoria": "Instrumentos Musicais",
    "descricao": [
      "atabaque, pandeiro, tambor"
    ]
  },
  {
    "nome": "Instrumentos de tecla",
    "categoria": "Instrumentos Musicais",
    "descricao": [
      "cravo, clavicórdio"
    ]
  ...
  {
    "nome": "Adestramento de cães",
    "categoria": "Outros Ofícios",
    "descricao": [
      "é especialista em treinar cachorros. Nas suas viagens, pode levar um ou dois cachorros comuns"
    ]
  },
  {
    "nome": "Administração",
    "categoria": "Outros Ofícios",
    "descricao": [
      "administração pode lidar com cargos envolvendo organização e burocracia, e pode servir em certos cargos governamentais. Os que também adquirem a habilidade acadêmica de Direito podem trabalhar como juízes, promotores e outros cargos"
    ]
  },
  {
    "nome": "Agricultura",
    "categoria": "Outros Ofícios",
    "descricao": [
      "Quem estuda agricultura é o lavrador ou trabalhador rural. Esta pessoa entende as técnicas do campo: quando e como plantar e colher produtos agrícolas"
    ]
  },
  {
    "nome": "Arquitetura",
    "categoria": "Outros Ofícios",
    "descricao": [
      "arquitetos lidam com planejamento e supervisão de construção de prédios"
    ]
  },
  {
    "nome": "Barbearia-cirurgia",
    "categoria": "Outros Ofícios",
    "descricao": [
      "Além de cortar barbas e cabelo, os barbeiros-cirurgiões podiam praticar pequenas cirurgias, como lancetar, arrancar dentes, ou amputar membros. Infelizmente, um dos seus tratamentos mais comum da época, sangria com sanguessugas ou flebotomia, era pouco eficaz na cura de doenças"
    ]
  },
  {
    "nome": "Carpintaria",
    "categoria": "Outros Ofícios",
    "descricao": [
      "carpinteiros trabalham com construção em madeira"
    ]
  },
  {
    "nome": "Cartografia",
    "categoria": "Outros Ofícios",
    "descricao": [
      "cartógrafos trabalham na confecção de mapas"
    ]
  },
  {
    "nome": "Comércio",
    "categoria": "Outros Ofícios",
    "descricao": [
      "comerciante lida com venda e compra de bens, precisa entender de logística de transporte e armazenagem, preço com base em oferta e demanda, avaliação da qualidade dos produtos e outros assuntos relacionados"
    ]
  },
  {
    "nome": "Condução de gado",
    "categoria": "Outros Ofícios",
    "descricao": [
      "boieiros (antigo nome para os vaqueiros/boiadeiros) trabalham com criação, proteção e controle de gado"
    ]
  },
  {
    "nome": "Contabilidade",
    "categoria": "Outros Ofícios",
    "descricao": [
      " pessoas que trabalham com contabilidade ocupam o cargo de tesoureiro"
    ]
  },
  {
    "nome": "Engenharia",
    "categoria": "Outros Ofícios",
    "descricao": [
      "engenheiros trabalham na projeção e supervisão na construção de projetos de engenharia civil (estradas, pontes) e mecânica (moinhos, engenhos de açúcar)"
    ]
  },
  {
    "nome": "Escriba",
    "categoria": "Outros Ofícios",
    "descricao": [
      "escrivães trabalham com a escrita e o arquivamento de documentos"
    ]
  },
  {
    "nome": "Fabricação de flechas",
    "categoria": "Outros Ofícios",
    "niveis": [
      "personagem pode gastar um dia na confecção de flechas, criando 5 flechas",
      "personagem pode gastar um dia na confecção de flechas, criando 10 flechas",
      "personagem pode gastar um dia na confecção de flechas, criando 20 flechas"
    ]
  },
  {
    "nome": "Mineração",
    "categoria": "Outros Ofícios",
    "descricao": [
      "este personagem é especialista em reconhecer depósitos de minerais e em técnicas de extração"
    ]
  },
  {
    "nome": "Pedraria",
    "categoria": "Outros Ofícios",
    "descricao": [
      "os pedreiros trabalham com o uso de pedra em construção"
    ]
  },
  {
    "nome": "Astronomia",
    ...
    "descricao": [
      "estudo dos movimentos das estrelas e planetas dentro da 'esfera celestial'"
    ]
  },
  {
    "nome": "Direito",
  ...
  },
  {
    ...
    "categoria": "Estudos Acadêmicos",
    "descricao": [
      "estudo de lógica, razão e metafísica, a essência dos seres"
    ]
  },
  {
    "nome": "Física",
  ...
  },
  {
    ...
    "categoria": "Estudos Acadêmicos",
    "descricao": [
      "inclui as áreas de gramática, o estudo de palavras e expressão linguística, nas formas de oração e poesia, e retórica, o estudo teórico de oratória e formação de argumentos para persuasão"
    ]
  },
  {
    "nome": "Matemática",
    "categoria": "Estudos Acadêmicos",
    "descricao": [
      "inclui as áreas de aritmética, o estudo de números e seus relacionamentos, e geometria, o estudo de medidas."
    ]
  },
  {
    "nome": "Medicina",
    "categoria": "Estudos Acadêmicos",
    "descricao": [
      "os médicos (chamados de “físicos”) podem recomendar remédios e tratamentos para doenças e condições comuns"
    ]
  },
  {
    "nome": "Teologia",
  ...
  },
  {
    ...
    "descricao": [
      "sente se existe algum perigo próximo, seja por causas naturais (fogo, tempestade), animais ou intenção humana. O poder não esclarece a forma exata do perigo, mas dá uma indicação da direção e o nível de perigo",
      "pede proteção contra ataques à sua pessoa ou contra outra pessoa escolhida (por toque). No caso de sucesso, qualquer ser (animal ou humano) estará sujeito a uma penalidade de -2 em qualquer ataque contra aquela pessoa durante o tempo da graça",
      "consegue mandar embora um ser maldoso ou perigoso (que seja pessoa, animal ou monstro)"
    ]
  },
  {
    "nome": "Defesa contra magia",
    "categoria": "Graças Divinas",
    "niveis": [
      "Sentir magia",
    ...
    "descricao": [
      "pede a graça de sentir os efeitos de poderes ao redor dele",
      "ganha proteção pessoal contra poderes mágicos",
      "consegue anular algum efeito mágico"
    ]
  },
  {
    "nome": "Profecia",
    ...
    "descricao": [
      "para receber uma visão, o personagem tem de estar em algum momento de paz e oração, relaxado e preparado para receber esta bênção. Uma visão pode ou não aparecer, pode ter ou não ter utilidade e pode até confundir mais que ajudar",
      "esta graça alerta o personagem sobre o estado de uma pessoa conhecida, mesmo que aquela pessoa esteja a milhares de quilômetros de distância",
      "quando usada com sucesso, deixa o personagem saber sem sombra de dúvida se outra pessoa está mentindo ou não. Em casos de grande sucesso, o personagem pode até receber uma visão que mostra o que é a verdade"
    ]
  },
  {
    "nome": "Recuperação",
    ...
    "descricao": [
      "recupera danos em uma parte do corpo e alivia a dor das outras, deixando aquela pessoa agir de forma normal. O personagem recupera imediatamente dois pontos de dano e, se continuar com menos de quatro pontos de resistência, não sofre a perda de um nível nos seus testes de habilidade durante as próximas 24 horas",
      "esta graça pode remover doenças e venenos listados como “comum” (como, por exemplo, o veneno da Armadeira gigante), e qualquer doença acompanhada de febre (varíola, peste, gripe e outras parecidas). Em caso de sucesso, o alvo começa a melhorar imediatamente, mas em caso de fracasso, o personagem nunca mais poderá fazer outro teste para remover aquela doença ou veneno da pessoa",
      "Este é o maior nível de cura, e pode aliviar enfermidades gravíssimas, como tuberculose, gota, diabetes e outras. É efetivo contra doenças e venenos listados como “incomum”, enlouquecimento sobrenatural, paralisia e os poderes de fôlego Enviar doença e Passar veneno. Também funciona em situações extraordinárias de saúde, por exemplo, quando alguém engole um anzol. Em caso de sucesso, o alvo começa a melhorar imediatamente, mas em caso de fracasso, o personagem nunca mais pode fazer outro teste para curar a mesma condição daquela pessoa"
    ]
  },
  {
    "nome": "Acontecimentos milagrosos",
    "categoria": "Graças Divinas",
    "niveis": [
      "Estender o clima",
      "Estender o dia",
    ...
    "descricao": [
      "esta graça segura uma chuva ou outro fenômeno natural durante até quatro horas, dando tempo para o personagem buscar abrigo",
      "esta graça pode ser invocada durante viagens terrestres ou marinhas, fazendo que as horas do dia pareçam estender-se além do normal para o personagem e seu grupo. Assim, eles conseguem andar o dobro da distância que andariam normalmente durante aquele dia. Este poder não afeta batalhas ou interações com outros personagens, apenas deslocamentos entre lugares",
      "em momentos de grande necessidade, o personagem pode pedir uma ajuda divina, que acaba aparecendo como uma coincidência inesperada"
    ]
  },
  {
    ...
    "categoria": "Graças Divinas",
    "niveis": [
      "Restaurar alimentação",
      "Encontrar alimentação",
      "Multiplicar alimentação"
    ],
    "descricao": [
      "pede que alguma comida ou bebida estragada volte a ser comestível",
      "em situações de necessidade, esta graça ajuda o personagem a encontrar comida e água",
      "em tempos de necessidade, esta graça permite que pouca comida alimente um número de pessoas além do normal"
    ]
  },
  {
    "nome": "Benção",
    ...
    "descricao": [
      "oferece bônus de +1 nos testes do ser ou objeto abençoado",
      "oferece bônus de +2 nos testes do ser ou objeto abençoado",
      "oferece bônus de +3 nos testes do ser ou objeto abençoado"
    ]
  },
  {
    "nome": "Fôlego",
    "categoria": "Poderes de Fôlego",
    "descricao": [
      "Energia 5",
      "Energia 10",
      "Energia 20"
  ...
  },
  {
    ...
    "descricao": [
      "poder de curar feridas, quando usado com sucesso, inicia uma cura extraordinária da ferida. Quando o personagem toca o alvo, cura imediatamente dois pontos de dano",
      "poder cura os efeitos de qualquer veneno (comum ou incomum). A pessoa começa a melhorar na hora, e todo o veneno e seus efeitos somem do corpo do afetado dentro de uma hora",
      "O pajé, sabendo que alguém está ferido, pode lançar uma cura à distância. O participante deve escolher entre Curar feridas ou Curar veneno. Não há limite de distância, mas uma penalidade pode ser aplicada ao teste em casos de distâncias muito grandes ou quando há desconhecimento do problema exato"
    ]
  },
  {
    "nome": "Defesa",
    ...
    "descricao": [
      "o alvo ganha +1 em todos os testes de habilidade até o próximo amanhecer. Ao contrário de outros poderes, é possível acumular mais de um bônus de Dar sorte, sob uma condição especial: o alvo pode somar até três aplicações deste poder ao mesmo tempo, contanto que receba de pajés diferentes",
      "O personagem ganha uma proteção que força uma penalidade de -2 ao teste de qualquer um que tente feri-lo por meio de armas, magia, doença ou veneno",
      "no caso de sucesso, não há arma, fogo ou outro elemento que consiga ferir o personagem. Ele pode ser derrubado por um golpe, amarrado ou detido por outros meios, ou afetado por poderes mágicos, mas não sofrerá dano algum. O efeito dura três rodadas de uma batalha"
    ]
  },
  {
    "nome": "Vida",
    ...
    "descricao": [
      "este poder recarrega as energias do alvo, tirando qualquer sinal de cansaço e fadiga. O alvo ganha o aumento de um ponto na sua resistência máxima durante 24 horas",
      "este poder pode curar qualquer doença (comum ou incomum). Também serve para remover enlouquecimento causado por criaturas sobrenaturais. Em caso de fracasso, o mesmo pajé nunca mais pode tentar curar a doença da mesma pessoa de novo",
      "o pajé pode soprar a vida de volta para dentro de um recém-morto. Este poder funciona em casos como falta de ar (estrangulação, afogamento), ataque cardíaco e perda de sangue, mas não serve em nenhum caso onde a causa da morte ainda persista no corpo"
    ]
  },
  {
    "nome": "Dano",
    ...
    "descricao": [
      " causa um machucado físico em outra pessoa, parecido com um golpe fortíssimo de uma arma (dano 3)",
      " introduz um veneno comum no sangue do alvo. Este veneno causa uma fraqueza, reduzindo todos os ataques do alvo para 1 de dano e reduzindo em um nível a sua movimentação. Se o veneno não for curado dentro de um dia, a pessoa morre",
      "produz o mesmo efeito que Causar feridas, porém o pajé pode aplicar este poder a qualquer um que se encontre dentro da sua linha de visão, sem necessidade de tocar o alvo"
    ]
  },
  {
    "nome": "Fraqueza",
    ...
    "descricao": [
      "o alvo atingido leva uma penalidade igual a -1 em todos seus testes de habilidade durante as próximas vinte e quatro horas",
      "O personagem torna-se suscetível aos ataques de armas, magia, doença e veneno, dando um bônus de +2 a qualquer um que o ataque. Uma pessoa só pode ser amaldiçoada por um uso de Indefeso por vez. O efeito dura doze horas",
  ...
  },
  {
    ...
    "descricao": [
      "o alvo fica exausto de repente, e tem que descansar uma rodada (perde a próxima ação) antes de fazer qualquer outra atividade",
      "aflige o alvo com uma doença comum. A doença impõe uma penalidade de -3 em todas as façanhas e baixa em um nível o movimento do alvo. Estes efeitos continuam até o alvo ser curado",
  ...
  },
  {
    ...
    "descricao": [
      "permite ao pajé prever o tempo das próximas doze horas",
      "o pajé bondoso pode criar chuva, o elemento que dá vida às plantas. O pajé maldoso pode criar uma seca fortíssima, tirando a vida das plantas. O ritual leva quatro horas a completar e o efeito dura de um a seis dias",
      "Com este poder, o pajé maldoso pode criar uma tempestade direcionada, lançando-a contra quem ele quiser. Esta tempestade terá chuva, vento e relâmpagos além do normal. O pajé bondoso pode usar este poder para acalmar uma tempestade (natural ou mágica), deixando uma chuva leve em seu lugar. Nos dois casos, o ritual leva apenas meia hora para completar"
    ]
  },
  {
    "nome": "Controle da natureza",
    "categoria": "Poderes de Fôlego",
    "niveis": [
      "Controle sobre plantas",
      "Criar alimentos",
      "Transformação"
    ],
    "descricao": [
      "o pajé bondoso pode fazer nascer uma planta nova, indo da semente até o broto em questão de meia hora. Para plantas menores (flores, ervas) a planta inteira cresce. No caso de uma árvore, ela cresce até um metro de altura. Uma árvore já madura ganha um ano de crescimento. O pajé maligno pode matar uma planta, fazendo até mesmo uma árvore grande decair. Nos dois casos, o ritual leva meia hora",
      "Com este poder, o pajé faz crescer uma pequena refeição vegetal, como um melão ou algumas cenouras, suficiente para alimentar uma pessoa. O ritual leva uma hora para completar",
      "este poder permite ao pajé transformar-se em animal. No caso do pajé bondoso, o animal pode ser um pássaro ou peixe. No caso do pajé maldoso, pode se tornar uma onça ou uma jararaca. O efeito é instantâneo  e o pajé pode ficar até oito horas na forma animal"
    ]
  },
  {
    "nome": "Contra magia",
    ...
    "descricao": [
      "o uso deste poder permite ao pajé saber quais são todos os itens mágicos e feitiços em efeito, sem identificar suas propriedades, dentro de um raio de trinta varas (33 metros)",
      "este poder, em caso de sucesso, permite ao pajé identificar as propriedades de um feitiço ou item mágico",
      "este poder pode ser utilizado para cancelar um ritual em andamento ou pôr um fim nos efeitos de um poder com uma certa duração"
    ]
  },
  {
    "nome": "Ifá",
    "categoria": "Poderes de Ifá",
    "descricao": [
      "Energia 5",
      "Energia 10",
      "Energia 20"
  ...
  },
  {
    ...
    "descricao": [
      "deste poder cura dois pontos de dano do alvo. Não pode ser utilizado no mesmo alvo mais de uma vez por dia",
      "Este poder cura os efeitos de qualquer veneno, paralisia ou doença (comum ou incomum). Também pode remover energias negativas do corpo causadas por Enfraquecer inimigo ou os poderes de Fôlego Indefeso ou Remover força",
      "preserva o corpo de um recém-morto (menos de um minuto) por 24 horas, sendo assim possível reverter os efeitos que causaram a morte e devolver a vida. Se a causa de morte não for anulada dentro deste período, a vida do alvo torna-se irrecuperável"
    ]
  },
  {
    "nome": "Detecção",
    ...
    "descricao": [
      "o sacerdote consegue detectar a presença de venenos em alimentos, bebidas ou outros lugares",
      "Detecta a presença de magia no ambiente, seja poderes ou objetos. Identifica, inclusive, graças divinas ativas",
      "O uso bem-sucedido deste poder permite ao sacerdote receber uma advertência sobre um obstáculo no seu caminho. O aviso é específico, e pode se referir a uma pessoa, criatura, objeto, lugar, situação ou qualquer outra coisa que pode impedir o sucesso do sacerdote no seu empreendimento atual"
    ]
  },
  {
    "nome": "Proteção",
    ...
    "descricao": [
      "o alvo pode escolher qualquer pessoa “inimiga” (que não precisa estar presente) para receber uma penalidade de -1 em qualquer teste contra o personagem. Também, se o personagem desejar evitar seu inimigo, torna-se mais difícil (porém não impossível) para aquele inimigo encontrá-lo. Este poder funciona até o próximo amanhecer",
      "este poder pode ser invocado durante combate, aplicando um bônus de +1 na defesa passiva do alvo até o final da batalha",
      "qualquer magia maliciosa utilizada contra o alvo sofre uma penalidade de -3 na façanha. O efeito dura uma hora"
    ]
  },
  {
    "nome": "Sorte",
    ...
    "descricao": [
      "o alvo pode escolher lançar novamente um dado em todas as suas façanhas",
      "o alvo pode escolher lançar novamente até dois dados em todas as suas façanhas",
      "o alvo pode escolher lançar novamente até três dados em todas as suas façanhas"
    ]
  },
  {
    ...
    "descricao": [
      "o uso deste poder causa dois pontos de dano. O contato físico é necessário",
      "o sacerdote consegue amaldiçoar um inimigo, causando uma penalidade de -2 em todos os testes do inimigo durante 24 horas. O ritual leva quatros horas e o inimigo não precisa estar presente",
      "este poder permite ao sacerdote mandar embora alguém com pretensões maldosas ou hostis. O inimigo não buscará nem molestará o sacerdote de nenhuma forma durante seis horas. O inimigo precisa estar no campo de visão do sacerdote para o poder funcionar. Funciona contra pessoas e criaturas de tamanho I ou menor. Seguidores de Ifá, Fé ou Fôlego são imunes a este poder"
    ]
  },
  {
    "nome": "Influência",
    ...
    "descricao": [
      "acalma alguém irritado ou bravo. Também pode ser usado para remover confusão ou loucura causada por criaturas sobrenaturais, fazendo o alvo pensar de forma clara e lúcida. O efeito é imediato, mas o alvo pode ficar irritado novamente, dependendo da situação",
      "influencia o sentimento do alvo sobre uma pessoa específica, fazendo o alvo ter uma opinião melhor ou pior daquela pessoa. O efeito dura seis horas, a não ser que seja anulado por Dissipar magia ou Contrafeitiço",
